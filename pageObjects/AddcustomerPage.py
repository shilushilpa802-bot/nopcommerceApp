...
class AddCustomer:
    ...
    def setCustomerRoles(self, role):
        ...
        if role == 'Guests':
            # Guest and Registered are mutually exclusive — remove existing role first
            time.sleep(3)
        ...
        time.sleep(3)
        self.driver.execute_script("arguments[0].click();", self.listitem)#javascript statement for click action
